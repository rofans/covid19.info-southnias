...
<section class="services">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <a href="travelling.php"><h3>Travelling</h3></a>
      </div>

      <div class="box">
         <img src="images/icon-2.png" alt="">
         <a href="new-normal.php"><h3>New Normal</h3></a>
      </div>

      <div class="box">
         <img src="images/icon-3.png" alt="">
         <a href="get-vaccinated.php"><h3>Get Vaccinated</h3></a>
      </div>

      <div class="box">
         <img src="images/icon-4.png" alt="">
         <a href="get-insured.php"><h3>Get Insured</h3></a>
      </div>

      <div class="box">
         <img src="images/icon-5.png" alt="">
         <a href="get-treated.php"><h3>Get Treated</h3></a>
      </div>
